...
% Last Modified by GUIDE v2.5 11-May-2018 11:04:27
...
backgroundImage =importdata('icon.jpg');
% 选择坐标系
axes(handles.axes1);
% 将图片添加到坐标系中，于是就成了背景了
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
 account=get(handles.edit1,'String');
 password=get(handles.edit2,'String');
 if (strcmp(account,'admin')==1)&&(strcmp(password,'admin')==1)
     set(gcf,'visible','off');
