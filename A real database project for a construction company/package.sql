CREATE OR REPLACE PACKAGE sale_operations AS
    PROCEDURE cancel_sale_record (v_invoice_id IN Sale.invoice_id%TYPE);
    PROCEDURE generate_next_id (
        p_table_name IN VARCHAR2,
        p_column_name IN VARCHAR2,
        p_next_id OUT NUMBER
    );
    PROCEDURE create_sale_record(
...
END sale_operations;
/
CREATE OR REPLACE PACKAGE BODY sale_operations AS
    /***************************
    PROCEDURE cancel_sale_record
    ****************************/
    PROCEDURE cancel_sale_record (v_invoice_id IN Sale.invoice_id%TYPE)
    IS
    ...
    ****************************/
    ...
    BEGIN
        ...
        -- TODO: Create a dbms_output here
